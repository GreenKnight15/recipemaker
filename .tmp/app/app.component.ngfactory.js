...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._Header_2_3 = new import15.Wrapper_Header(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_2), this.renderer, this.parentInjector.get(import26.ViewController, null));
        ...
        var compView_4 = import15.viewFactory_Toolbar0(this.viewUtils, this.injector(4), this._appEl_4);
        this._Toolbar_4_4 = new import15.Wrapper_Toolbar(this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_4), this.renderer);
        ...
        this._ToolbarTitle_6_4 = new import16.Wrapper_ToolbarTitle(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_6), this.renderer, this._Toolbar_4_4.context, this.parentInjector.get(import27.Navbar, null));
        ...
        var compView_11 = import17.viewFactory_Content0(this.viewUtils, this.injector(11), this._appEl_11);
        ...
        this._el_20 = this.renderer.createElement(parentRenderNode, 'ion-menu', null);
        ...
        var compView_20 = import14.viewFactory_Menu0(this.viewUtils, this.injector(20), this._appEl_20);
        ...
        this._query_Content_20_0 = new import13.QueryList();
        this._appEl_20.initComponent(this._Menu_20_4.context, [], compView_20);
        this._text_21 = this.renderer.createText(null, '\n  ', null);
        this._el_22 = this.renderer.createElement(null, 'ion-header', null);
        this._Header_22_3 = new import15.Wrapper_Header(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_22), this.renderer, this.parentInjector.get(import26.ViewController, null));
        this._text_23 = this.renderer.createText(this._el_22, '\n    ', null);
        this._el_24 = this.renderer.createElement(this._el_22, 'ion-toolbar', null);
        this.renderer.setElementAttribute(this._el_24, 'class', 'toolbar');
        this._appEl_24 = new import3.AppElement(24, 22, this, this._el_24);
        var compView_24 = import15.viewFactory_Toolbar0(this.viewUtils, this.injector(24), this._appEl_24);
        this._Toolbar_24_4 = new import15.Wrapper_Toolbar(this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_24), this.renderer);
        this._appEl_24.initComponent(this._Toolbar_24_4.context, [], compView_24);
        this._text_25 = this.renderer.createText(null, '\n      ', null);
        this._el_26 = this.renderer.createElement(null, 'ion-title', null);
        this._appEl_26 = new import3.AppElement(26, 24, this, this._el_26);
        var compView_26 = import16.viewFactory_ToolbarTitle0(this.viewUtils, this.injector(26), this._appEl_26);
        this._ToolbarTitle_26_4 = new import16.Wrapper_ToolbarTitle(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_26), this.renderer, this._Toolbar_24_4.context, this.parentInjector.get(import27.Navbar, null));
        this._appEl_26.initComponent(this._ToolbarTitle_26_4.context, [], compView_26);
        this._text_27 = this.renderer.createText(null, 'Menu', null);
        compView_26.create(this._ToolbarTitle_26_4.context, [[].concat([this._text_27])], null);
        ...
        this._el_31 = this.renderer.createElement(null, 'ion-content', null);
        this._appEl_31 = new import3.AppElement(31, 20, this, this._el_31);
        var compView_31 = import17.viewFactory_Content0(this.viewUtils, this.injector(31), this._appEl_31);
        ...
        this._appEl_31.initComponent(this._Content_31_4.context, [], compView_31);
        this._text_32 = this.renderer.createText(null, '\n    ', null);
        this._el_33 = this.renderer.createElement(null, 'ion-list', null);
        ...
        compView_20.create(this._Menu_20_4.context, [[].concat([
                this._text_21,
                this._el_22,
                this._text_30,
                this._el_31,
        ...
        this._el_41 = this.renderer.createElement(parentRenderNode, 'ion-nav', null);
        ...
        var compView_41 = import20.viewFactory_Nav0(this.viewUtils, this.injector(41), this._appEl_41);
        this._Nav_41_4 = new import20.Wrapper_Nav(this.parentInjector.get(import26.ViewController, null), this.parentInjector.get(import32.NavControllerBase, null), this.parentInjector.get(import28.App), this.parentInjector.get(import22.Config), this.parentInjector.get(import23.Keyboard), new import21.ElementRef(this._el_41), this.parentInjector.get(import24.NgZone), this.renderer, this.parentInjector.get(import33.ComponentFactoryResolver), this.parentInjector.get(import25.GestureController), this.parentInjector.get(import34.TransitionController), this.parentInjector.get(import35.DeepLinker, null));
        this._appEl_41.initComponent(this._Nav_41_4.context, [], compView_41);
        compView_41.create(this._Nav_41_4.context, [], null);
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import36.ToolbarTitle) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 7)))) {
            return this._ToolbarTitle_6_4.context;
        }
        if (((token === import37.Toolbar) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 8)))) {
            return this._Toolbar_4_4.context;
        }
        if (((token === import37.Header) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 9)))) {
            return this._Header_2_3.context;
        }
        if (((token === import30.TemplateRef) && (15 === requestNodeIndex))) {
            return this._TemplateRef_15_5;
        }
        if (((token === import38.NgFor) && (15 === requestNodeIndex))) {
            return this._NgFor_15_6.context;
        }
        if (((token === import39.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) {
            return this._List_13_3.context;
        }
        if (((token === import40.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 17)))) {
            return this._Content_11_4.context;
        }
        if (((token === import41.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
            return this._Menu_0_4.context;
        }
        if (((token === import36.ToolbarTitle) && ((26 <= requestNodeIndex) && (requestNodeIndex <= 27)))) {
            return this._ToolbarTitle_26_4.context;
        }
        if (((token === import37.Toolbar) && ((24 <= requestNodeIndex) && (requestNodeIndex <= 28)))) {
            return this._Toolbar_24_4.context;
        }
        if (((token === import37.Header) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 29)))) {
            return this._Header_22_3.context;
        }
        if (((token === import30.TemplateRef) && (35 === requestNodeIndex))) {
            return this._TemplateRef_35_5;
        }
        if (((token === import38.NgFor) && (35 === requestNodeIndex))) {
            return this._NgFor_35_6.context;
        }
        if (((token === import39.List) && ((33 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
            return this._List_33_3.context;
        }
        if (((token === import40.Content) && ((31 <= requestNodeIndex) && (requestNodeIndex <= 37)))) {
            return this._Content_31_4.context;
        }
        if (((token === import41.Menu) && ((20 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
            return this._Menu_20_4.context;
        }
        if (((token === import42.Nav) && (41 === requestNodeIndex))) {
            return this._Nav_41_4.context;
        }
        return notFoundResult;
    };
    _View_MyApp0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0 = this._Nav_41_4.context;
        ...
        var currVal_7 = this._Toolbar_24_4.context._sbPadding;
        if (import4.checkBinding(throwOnChange, this._expr_7, currVal_7)) {
            this.renderer.setElementClass(this._el_24, 'statusbar-padding', currVal_7);
            this._expr_7 = currVal_7;
        }
        var currVal_8 = this._Content_31_4.context._sbPadding;
        ...
        if (!throwOnChange) {
            if ((this.numberOfChecks === 0)) {
                this._Nav_41_4.context.ngAfterViewInit();
            }
        }
    };
...
var _View_MyApp1 = (function (_super) {
    ...
    _View_MyApp1.prototype.createInternal = function (rootSelector) {
        ...
        this._Item_0_4 = new import43.Wrapper_Item(this.parent.parentInjector.get(import45.Form), this.parent.parentInjector.get(import22.Config), new import21.ElementRef(this._el_0), this.renderer, this.parent.parentInjector.get(import46.ItemReorder, null));
    ...
    _View_MyApp1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import48.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
