...
import * as import0 from './created-recipes';
...
export var Wrapper_CreatedRecipes = (function () {
    function Wrapper_CreatedRecipes(p0, p1, p2, p3) {
        this.changed = false;
        this.context = new import0.CreatedRecipes(p0, p1, p2, p3);
    }
    Wrapper_CreatedRecipes.prototype.detectChangesInternal = function (view, el, throwOnChange) {
    ...
    return Wrapper_CreatedRecipes;
}());
var renderType_CreatedRecipes_Host = null;
var _View_CreatedRecipes_Host0 = (function (_super) {
    __extends(_View_CreatedRecipes_Host0, _super);
    function _View_CreatedRecipes_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_CreatedRecipes_Host0, renderType_CreatedRecipes_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_CreatedRecipes_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-created-recipes', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_CreatedRecipes0(this.viewUtils, this.injector(0), this._appEl_0);
        this._CreatedRecipes_0_4 = new Wrapper_CreatedRecipes(this.parentInjector.get(import8.NavController), this.parentInjector.get(import9.RecipeService), this.parentInjector.get(import10.AuthService), this.parentInjector.get(import11.ModalController));
        this._appEl_0.initComponent(this._CreatedRecipes_0_4.context, [], compView_0);
        compView_0.create(this._CreatedRecipes_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_CreatedRecipes_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.CreatedRecipes) && (0 === requestNodeIndex))) {
            return this._CreatedRecipes_0_4.context;
        }
        return notFoundResult;
    };
    _View_CreatedRecipes_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._CreatedRecipes_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_CreatedRecipes_Host0;
}(import1.AppView));
function viewFactory_CreatedRecipes_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_CreatedRecipes_Host === null)) {
        (renderType_CreatedRecipes_Host = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, [], {}));
    }
    return new _View_CreatedRecipes_Host0(viewUtils, parentInjector, declarationEl);
}
export var CreatedRecipesNgFactory = new import13.ComponentFactory('page-created-recipes', viewFactory_CreatedRecipes_Host0, import0.CreatedRecipes);
var styles_CreatedRecipes = [];
var renderType_CreatedRecipes = null;
var _View_CreatedRecipes0 = (function (_super) {
    __extends(_View_CreatedRecipes0, _super);
    function _View_CreatedRecipes0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_CreatedRecipes0, renderType_CreatedRecipes, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_CreatedRecipes0.prototype.createInternal = function (rootSelector) {
        ...
        this._Content_1_4 = new import14.Wrapper_Content(this.parentInjector.get(import17.Config), new import18.ElementRef(this._el_1), this.renderer, this.parentInjector.get(import19.App), this.parentInjector.get(import20.Keyboard), this.parentInjector.get(import21.NgZone), this.parentInjector.get(import22.ViewController, null), this.parentInjector.get(import23.Tabs, null));
        ...
        this._List_3_3 = new import15.Wrapper_List(this.parentInjector.get(import17.Config), new import18.ElementRef(this._el_3), this.renderer, this.parentInjector.get(import24.GestureController));
        ...
        this._TemplateRef_5_5 = new import25.TemplateRef_(this._appEl_5, viewFactory_CreatedRecipes1);
        this._NgFor_5_6 = new import16.Wrapper_NgFor(this._appEl_5.vcRef, this._TemplateRef_5_5, this.parentInjector.get(import26.IterableDiffers), this.ref);
    ...
    _View_CreatedRecipes0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import25.TemplateRef) && (5 === requestNodeIndex))) {
            return this._TemplateRef_5_5;
        }
        if (((token === import27.NgFor) && (5 === requestNodeIndex))) {
            return this._NgFor_5_6.context;
        }
        if (((token === import28.List) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 6)))) {
            return this._List_3_3.context;
        }
        if (((token === import29.Content) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 6)))) {
            return this._Content_1_4.context;
        }
        return notFoundResult;
    };
    _View_CreatedRecipes0.prototype.detectChangesInternal = function (throwOnChange) {
        if (this._Content_1_4.detectChangesInternal(this, this._el_1, throwOnChange)) {
            this._appEl_1.componentView.markAsCheckOnce();
        }
        this._List_3_3.detectChangesInternal(this, this._el_3, throwOnChange);
        var currVal_1 = this.context.userRecipes;
        this._NgFor_5_6.check_ngForOf(currVal_1, throwOnChange, false);
    ...
    _View_CreatedRecipes0.prototype.destroyInternal = function () {
        this._Content_1_4.context.ngOnDestroy();
    };
    return _View_CreatedRecipes0;
}(import1.AppView));
export function viewFactory_CreatedRecipes0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_CreatedRecipes === null)) {
        (renderType_CreatedRecipes = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, styles_CreatedRecipes, {}));
    }
    return new _View_CreatedRecipes0(viewUtils, parentInjector, declarationEl);
}
var _View_CreatedRecipes1 = (function (_super) {
    __extends(_View_CreatedRecipes1, _super);
    function _View_CreatedRecipes1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_CreatedRecipes1, renderType_CreatedRecipes, import6.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_CreatedRecipes1.prototype.createInternal = function (rootSelector) {
        ...
        this._ItemSliding_0_4 = new import30.Wrapper_ItemSliding(this.parent._List_3_3.context, this.renderer, new import18.ElementRef(this._el_0), this.parent.parentInjector.get(import21.NgZone));
    ...
    _View_CreatedRecipes1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_CreatedRecipes1.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_CreatedRecipes1.prototype.destroyInternal = function () {
        this._Icon_22_3.context.ngOnDestroy();
        this._Icon_33_3.context.ngOnDestroy();
        this._Icon_52_3.context.ngOnDestroy();
    };
    _View_CreatedRecipes1.prototype._handle_click_6_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.parent.context.recipeSelected(this.context.$implicit) !== false);
        return (true && pd_0);
    };
    return _View_CreatedRecipes1;
}(import1.AppView));
function viewFactory_CreatedRecipes1(viewUtils, parentInjector, declarationEl) {
    return new _View_CreatedRecipes1(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=created-recipes.ngfactory.js.map